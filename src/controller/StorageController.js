...
exports.getAllStorageVertical_1 = async (req,res) => {
    try {
        let dataStorage = await storage.getAllStorageVertical_1();
...
exports.getAllStorageVertical_2 = async (req,res) => {
    try {
        let dataStorage = await storage.getAllStorageVertical_2();
